...
export const HeroTemplateHorizontal = () => {
  return (
    <main className="relative text-left bg-black">
      <div>
        <div className="items-center text-center md:text-left max-w-[1600px] mx-auto h-screen w-full flex flex-col justify-center md:justify-around md:items-center md:flex-row sm:px-8 md:px-14 pb-16">
          <Image
